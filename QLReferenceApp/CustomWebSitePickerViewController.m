...
static NSString* const FAULTY_URL_ERROR_MESSAGE_MESSAGE = @"The url that you inputed: %@ is not in the right format. Please put in a url with the correct format. For example http://www.qualifylabs.com";
static NSString* const ALERT_CANCEL_BUTTON_TITLE = @"OK";
static NSString* const SUBMIT_BUTTON_TTITLE = @"Go";
static NSString* const TEXT_FIELD_PLACE_HOLDER_WEBSITE = @"http://www.qualifylabs.com";
